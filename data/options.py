...
def option():
    # Training settings
    parser = argparse.ArgumentParser(description='CSPVSF')
    ...
    parser.add_argument('--dino_weight', type=float, default=0.1, help='weight for dino loss')  # === 新增 ===
    parser.add_argument('--vit_path', type=str, default='./pretrain/dinov2_vitb14_reg4_pretrain1.pth', help='path to vit pretrained weights')  # === 新增 ===
